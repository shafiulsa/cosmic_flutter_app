...
class UserController extends GetxController {
  ...
  Future<void> saveUserRecord(UserCredential userCredential) async {
    try {
      ...
      final username = '${userCredential.user!.displayName}2312637'; // Placeholder UID
      ...
      SSnackBarHelpers.warningSnackBar(title: 'Data not saved', message: 'Something went wrong while saving user data: ${e.toString()}');
    }
  }
